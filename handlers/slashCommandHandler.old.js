...
async function showQuestion(interaction, userId, category, questionIndex) {
  ...
  const userProgress = userProgressManager.getUserProgress(userId);
  if (!userProgress) {
  ...
  const categoryTitle = questionHandler.getCategoryTitle(category);
      ...
      try {
        ...
        await interaction.reply({
          ...
          flags: MessageFlags.Ephemeral,
               ...
               (interaction.customId.startsWith('question_answer_') ||
                interaction.customId.startsWith('submit_multi_select_') ||
                interaction.customId.startsWith('more_options_') ||
                interaction.customId.startsWith('back_to_main_') ||
                interaction.customId.startsWith('form_single_select_') ||
                interaction.customId.startsWith('form_multi_select_') ||
                interaction.customId.startsWith('next_question_') ||
                interaction.customId.startsWith('complete_form_'))) {
...
// REMOVED: Function moved to InteractionRouter - commenting out to reduce file size
...
// REMOVED: Function moved to InteractionRouter
